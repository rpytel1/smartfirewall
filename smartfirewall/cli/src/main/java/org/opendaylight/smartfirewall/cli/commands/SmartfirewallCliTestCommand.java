 ...
 */
package org.opendaylight.smartfirewall.cli.commands;
...
public class SmartfirewallCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(SmartfirewallCliTestCommand.class);
    protected final SmartfirewallCliCommands service;

    public SmartfirewallCliTestCommand(final SmartfirewallCliCommands service) {
